...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
<div class="titulo_ruta" style="height:30px; padding-top:10px;"><a href="/inicio/" class="titulo_ruta">vendorepuestos.com.ve</a> > <a href="/<?=$carpeta?>/<?=$id?>/0/0/1" class="titulo_ruta"><?=$vt["nombre_oficial"]?></a> > <?=cual_menu($idm);?></div>
</td>
