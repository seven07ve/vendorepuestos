...
<div class="titulo_ruta" style="height:30px; padding-top:10px;"><a href="/inicio/" class="titulo_ruta">vendorepuestos.com.ve</a> > <a href="/tiendarepuestos/all/1/" class="titulo_ruta">Tiendarepuestos</a> <? if($palabra_tienda!=""){?> > <? echo $palabra_tienda; }?></div>
 ...
 <a href="/salirTR/" class="red" target="_self">(Salir)</a> | <a href="/mitr/<?=cual_nombre_carpeta($_SESSION["userid"])?>/" class="red">Mi Cuenta</a>
<? 
			}
			elseif($_SESSION["userid"]=="")
			{?>
			<a href="/registroTR/" class="blue">¿Deseas una TIENDAREPUESTOS?</a> | <a href="/iniciar_sesion/" class="red">Mi Cuenta</a>
<? }?></td>
  </tr>
</table>
