...
if(isset($_POST["paso"])==2)
{
	...
	Para su publicación el proceso toma tres sencillos pasos.<br>
	1.	Realiza el pago a su conveniencia.<br>
	2.	Repórtalo en el Centro de Pagos.<br>
	3.	Espera la activación de acuerdo a los Términos y Condiciones especificados en la secciópn de Tarifas.<br><br>
	...
	Si desea realizar modificaciones, usa la sección Modificar artículo. <br><br> 
	...
	if($_POST["desea_cliente_premium"]=="si")//email al cliente
	{
		...
		Esta información puede enviarla al siguiente correo administracion@vendorepuestos.com.ve, indicando el número de artículo y documento de identidad bajo el cual esté siendo registrado.<br><br>
...
<?=$monto_paquete?></span>
  ...
  <tr>
    ...
    <td align="center"><a href="<?php echo HTTP_PTO_VENTA . "$params" ?>"><img src="/imagenes/TRANSFERENCIA ICONO.jpg" width="150" height="69" border="0" /></a></td>
          ...
          <div class="blue" align="center">Complete los datos en línea y comienza a vender tus productos</div>
