...
$GLOBALS['strRetryUpdate']					= "Riprova aggiornamento";
...
$GLOBALS['strMysql4Compatibility']			= "Utilizza modalit&agrave; SQL di MySQL 4 per garantire il funzionamento di phpAdsNew";
...
$GLOBALS['strWarnLimitErr']					= "Il limite di avvertimento deve essere un numero positivo";
$GLOBALS['strWarnLimitDays']				= "Invia un avviso quando il numero di giorni rimasti sono inferiori a";
$GLOBALS['strWarnLimitDaysErr']				= "Il limite di avvertimento in giorni deve essere un numero positivo";
