...
$GLOBALS['strSwfTransparency']				= "Sfondo trasparente (solo Flash)";
...
$GLOBALS['strWarnClientDaysTxt']			= "La campagna scadrà il {date}. I tuoi banner verranno disabilitati una volta raggiunta tale data. ";
$GLOBALS['strViewsClicksLow']				= "Le visualizzazioni/click stanno terminando";
$GLOBALS['strCampaignExpiring']				= "Campagna in scadenza";
