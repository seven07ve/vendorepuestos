...
$GLOBALS['strInvocationAdLayer']		= "Interstíciós vagy Lebegõ DHTML";
...
$GLOBALS['strInvocationClientID']		= "Hirdetõ vagy kampány";
...
$GLOBALS['strPopUpCreateInstance']		= "Elõfordulás az elõugrás létrehozásakor";
...
$GLOBALS['strPopUpTop']				= "Kezdõ pozíció (fent)";
$GLOBALS['strPopUpLeft']			= "Kezdõ pozíció (balra)";
...
$GLOBALS['strWindowResizable']		= "Méretezhetõ";
$GLOBALS['strShowScrollbars']		= "Gördítõsávok";
...
$GLOBALS['strVAlignment']			= "Függõleges igazítás";
...
$GLOBALS['strVShift']				= "Függõleges eltolás";
