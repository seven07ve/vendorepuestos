...
$GLOBALS['strHome'] 				= "Kezdõlap";
$GLOBALS['strHelp']				= "Súgó";
$GLOBALS['strNavigation'] 			= "Navigálás";
$GLOBALS['strShortcuts'] 			= "Parancsikonok";
$GLOBALS['strAdminstration'] 			= "Nyilvántartó";
$GLOBALS['strMaintenance']			= "Karbantartás";
$GLOBALS['strProbability']			= "Valószínûség";
$GLOBALS['strInvocationcode']			= "Híváskód";
$GLOBALS['strBasicInformation'] 		= "Alapinformáció";
$GLOBALS['strContractInformation'] 		= "Megállapodás adatai";
$GLOBALS['strLoginInformation'] 		= "Belépési adatok";
$GLOBALS['strOverview']				= "Áttekintés";
$GLOBALS['strSearch']				= "<u>K</u>eresés";
$GLOBALS['strHistory']				= "Elõzmények";
$GLOBALS['strPreferences'] 			= "Beállítások";
$GLOBALS['strDetails']				= "Részletek";
$GLOBALS['strCompact']				= "Tömörített";
$GLOBALS['strVerbose']				= "Részletes";
$GLOBALS['strUser']				= "Felhasználó";
$GLOBALS['strEdit']				= "Szerkesztés";
$GLOBALS['strCreate']				= "Létrehozás";
$GLOBALS['strDuplicate']			= "Kettõzés";
$GLOBALS['strMoveTo']				= "Áthelyezés ide";
$GLOBALS['strDelete'] 				= "Törlés";
$GLOBALS['strActivate']				= "Aktiválás";
$GLOBALS['strDeActivate'] 			= "Deaktiválás";
$GLOBALS['strConvert']				= "Konvertálás";
$GLOBALS['strRefresh']				= "Frissítés";
$GLOBALS['strSaveChanges']		 	= "Módosítások mentése";
$GLOBALS['strUp'] 				= "Fel";
$GLOBALS['strDown'] 				= "Le";
$GLOBALS['strSave'] 				= "Mentés";
$GLOBALS['strCancel']				= "Mégse";
$GLOBALS['strPrevious'] 			= "Vissza";
$GLOBALS['strPrevious_Key'] 			= "<u>V</u>issza";
$GLOBALS['strNext'] 				= "Tovább";
$GLOBALS['strNext_Key'] 				= "<u>T</u>ovább";
$GLOBALS['strYes']				= "Igen";
$GLOBALS['strNo']				= "Nem";
$GLOBALS['strNone'] 				= "Nincs";
$GLOBALS['strCustom']				= "Egyéni";
$GLOBALS['strDefault'] 				= "Alapértelmezett";
$GLOBALS['strOther']				= "Egyéb";
$GLOBALS['strUnknown']				= "Ismeretlen";
$GLOBALS['strUnlimited'] 			= "Korlátlan";
$GLOBALS['strUntitled']				= "Korlátlan";
$GLOBALS['strAll'] 				= "mind";
$GLOBALS['strAvg'] 				= "Átl.";
$GLOBALS['strAverage']				= "Átlag";
$GLOBALS['strOverall'] 				= "Összegzés";
$GLOBALS['strTotal'] 				= "Összesen";
$GLOBALS['strActive'] 				= "aktív";
$GLOBALS['strFrom']				= "Mettõl";
$GLOBALS['strTo']				= "meddig";
$GLOBALS['strLinkedTo'] 			= "kapcsolva";
$GLOBALS['strDaysLeft'] 			= "Nnp maradt";
$GLOBALS['strCheckAllNone']			= "Mind kijelölése / törlése";
$GLOBALS['strKiloByte']				= "KB";
$GLOBALS['strExpandAll']			= "Mind <u>k</u>inyitása";
$GLOBALS['strCollapseAll']			= "Mind össze<u>c</u>sukása";
$GLOBALS['strShowAll']				= "Mind megjelenítése";
$GLOBALS['strNoAdminInteface']			= "A szolgáltatás nem elérhetõ...";
$GLOBALS['strFilterBySource']			= "szûrés forrás alapján";
$GLOBALS['strFieldContainsErrors']		= "A következõ mezõk hibásak:";
$GLOBALS['strFieldFixBeforeContinue1']		= "A folytatás elõtt";
$GLOBALS['strFieldFixBeforeContinue2']		= "javítsa ki a hibákat.";
$GLOBALS['strDelimiter']			= "Elválasztó";
$GLOBALS['strMiscellaneous']		= "Egyebek";
$GLOBALS['strCollectedAll']			= "Minden összegyûjtött statisztika";
$GLOBALS['strCollectedToday']		= "A mai nap statisztikája";
...
$GLOBALS['strWelcomeTo']			= "Üdvözli a";
$GLOBALS['strEnterUsername']			= "Írja be a felhasználónevet és a jelszót a belépéshez";
$GLOBALS['strEnterBoth']			= "Írja be a felhasználónevet is, és a jelszót is";
$GLOBALS['strEnableCookies']			= "Engedélyezze a cookie-kat a ".$phpAds_productname." használata elõtt";
$GLOBALS['strLogin'] 				= "Belépés";
$GLOBALS['strLogout'] 				= "Kilépés";
$GLOBALS['strUsername'] 			= "Felhasználó";
$GLOBALS['strPassword']				= "Jelszó";
$GLOBALS['strAccessDenied']			= "A hozzáférés megtagadva";
$GLOBALS['strPasswordWrong']			= "Az ön által megadott jelszó hibás";
$GLOBALS['strNotAdmin']				= "Lehet, hogy ön nem rendelkezik megfelelõ jogosultsággal";
$GLOBALS['strDuplicateClientName']		= "Az ön által megadott felhasználónév már létezik. Adjon meg másik felhasználónevet.";
$GLOBALS['strInvalidPassword']			= "A jelszó érvénytelen, használjon másik jelszót.";
$GLOBALS['strNotSamePasswords']			= "Az ön által megadott két jelszó nem azonos";
$GLOBALS['strRepeatPassword']			= "A jelszó megerõsítése";
...
$GLOBALS['strCTRShort'] 			= "Katt";
$GLOBALS['strCTR'] 				= "Kattintási arány";
$GLOBALS['strTotalViews'] 			= "Összes letöltés";
$GLOBALS['strTotalClicks'] 			= "Összes kattintás";
$GLOBALS['strViewCredits'] 			= "Letöltés követelés";
$GLOBALS['strClickCredits'] 			= "Kattintás követelés";
...
$GLOBALS['strMonth'] 				= array("Január","Február","Március","Április","Május","Június","Július", "Augusztus", "Szeptember", "Október", "November", "December");
$GLOBALS['strDayShortCuts'] 			= array("Va","He","Ke","Sz","Cs","Pe","Szo");
$GLOBALS['strHour']				= "Óra";
...
// Advertiser
$GLOBALS['strClient']				= "Hirdetõ";
$GLOBALS['strClients'] 				= "Hirdetõk";
$GLOBALS['strClientsAndCampaigns']		= "Hirdetõk és kampányok";
$GLOBALS['strAddClient'] 			= "Új hirdetõ";
$GLOBALS['strAddClient_Key'] 		= "Ú<u>j</u> hirdetõ";
$GLOBALS['strTotalClients'] 			= "Összes hirdetõ";
$GLOBALS['strClientProperties']			= "Hirdetõ tulajdonságai";
$GLOBALS['strClientHistory']			= "Hirdetõ elõzményei";
$GLOBALS['strNoClients']			= "Jelenleg nincsenek hirdetõk";
$GLOBALS['strConfirmDeleteClient'] 		= "Valóban törli ezt a hirdetõt?";
$GLOBALS['strConfirmResetClientStats']		= "Valóban törli ennek a hirdetõnek a létezõ statisztikáit?";
$GLOBALS['strHideInactiveAdvertisers']		= "Inaktív hirdetõk elrejtése";
$GLOBALS['strInactiveAdvertisersHidden']	= "inaktív hirdetõ elrejtve";
...
$GLOBALS['strCampaignHistory']			= "Kampány elõzményei";
$GLOBALS['strNoCampaigns']			= "Jelenleg nincsenek kampányok";
$GLOBALS['strConfirmDeleteAllCampaigns']	= "Valóban törli ennek a hirdetõnek az összes kampányát?";
...
$GLOBALS['strViewsPurchased'] 			= "Visszalévõ letöltés";
$GLOBALS['strClicksPurchased'] 			= "Visszalévõ kattintás";
...
$GLOBALS['strLowPriority']			= "A reklám megjelenítése alacsony prioritással ebben a reklámban.<br> Ez a kampány kerül felhasználásra azon hátralévõ letöltések megjelenítésére, melyeket nem használnak a magas prioritású kampányok.";
$GLOBALS['strTargetLimitAdviews']		= "A reklámletöltések számának korlátozása:";
$GLOBALS['strTargetPerDay']			= "naponta.";
$GLOBALS['strPriorityAutoTargeting']		= "A maradék reklámletöltések egyenletes elosztása a maradék napok számán túl. A reklámletöltések célzott száma minden napnak megfelelõen kerül beállításra.";
...
$GLOBALS['strBannerHistory']			= "Reklám elõzményei";
...
$GLOBALS['strShowParentCampaigns']		= "Szülõ kampányok megjelenítése";
$GLOBALS['strHideParentCampaigns']		= "Szülõ kampányok elrejtése";
$GLOBALS['strHideInactiveBanners']		= "Inaktív reklámok elrejtése";
$GLOBALS['strInactiveBannersHidden']		= "inaktív reklám elrejtve";
$GLOBALS['strAppendOthers']				= "Egyebek hozzáfûzése";
$GLOBALS['strAppendTextAdNotPossible']	= "Szöveges hirdetésekhez nem lehet másik reklámot hozzáfûzni.";
...
$GLOBALS['strURLBanner'] 			= "Külsõ reklám";
...
$GLOBALS['strUploadOrKeep']			= "Megtartja a létezõ képet, <br>vagy tölt fel egy másikat?";
...
$GLOBALS['strConvertSWF']			= "<br>Az imént feltöltött Flash fájl nehezen módosítható hivatkozásokat tartalmaz. Ilyen reklám esetén a phpAdsNew csak akkor tudja követni a kattintások számát, ha ön átalakítja ezeket a nehezen módosítható hivatkozásokat. Az alábbiakban található a Flash fájlban lévõ hivatkozások listája. Ha kívánja konvertálni a hivatkozásokat, kattintson a <b>Konvertálás</b> gombra, egyéb esetben a <b>Mégse</b> gombra.<br><br>Ne feledje: ha a <b>Konvertálás</b> gombra kattint, akkor az imént feltöltött Flash fájlt fizikailag fogja módosítani. <br>Készítsen másolatot az eredeti fájlról. Tekintet nélkül a verzióra, mellyel ezt a reklámot készítette, az eredményül kapott fájl megfelelõ megjelenítéséhez a Flash 4 lejátszó (vagy újabb) szükséges.<br><br>";
...
$GLOBALS['strNoLimitations']			= "Nincs korlátozás";
$GLOBALS['strApplyLimitationsTo']		= "Korlátozás alkalmazása a következõre";
$GLOBALS['strRemoveAllLimitations']		= "Minden korlátozás eltávolítása";
$GLOBALS['strEqualTo']					= "egyenlõ ezzel:";
$GLOBALS['strDifferentFrom']			= "eltérõ ettõl:";
$GLOBALS['strLaterThan']				= "késõbbi, mint";
$GLOBALS['strLaterThanOrEqual']			= "késõbbi, vagy egyenlõ ezzel:";
...
$GLOBALS['strTimeCapping']				= "Ugyanaz a felhasználó a továbbítás után nem láthatja a reklámot a következõ idõpontig:";
...
$GLOBALS['strAffiliateHistory']			= "Kiadó elõzményei";
...
$GLOBALS['strAllowAffiliateDeleteZone'] 	= "A felhasználó törölhet létezõ zónákat";
...
$GLOBALS['strZoneHistory']			= "Zóna elõzményei";
...
$GLOBALS['strInterstitial']			= "Interstíciós vagy lebegõ DHTML";
$GLOBALS['strPopup']				= "Felbukkanó ablak";
$GLOBALS['strTextAdZone']			= "Szöveges hirdetés";
$GLOBALS['strShowMatchingBanners']		= "Egyezõ reklámok megjelenítése";
$GLOBALS['strHideMatchingBanners']		= "Egyezõ reklámok elrejtése";
...
$GLOBALS['strZoneAppend']			= "A következõ HTML kód mindenkori hozzáfûzése a zóna által megjelenített reklámokhoz";
$GLOBALS['strAppendSettings']			= "Hozzáfûzés beállításai";
$GLOBALS['strZonePrependHTML']			= "A HTML-kód hozzáfûzése a zóna által megjelenített szöveges hirdetések elõtt";
$GLOBALS['strZoneAppendHTML']			= "A HTML-kód hozzáfûzése a zóna által megjelenített szöveges hirdetések után";
$GLOBALS['strZoneAppendType']			= "Hozzáfûzés típusa";
$GLOBALS['strZoneAppendHTMLCode']		= "HTML kód";
$GLOBALS['strZoneAppendZoneSelection']	= "Felbukkanó vagy interstíciós ablak";
$GLOBALS['strZoneAppendSelectZone']		= "A következõ felbukkanó vagy interstíciós ablakok mindenkori hozzáfûzése a zóna által megjelenített reklámok elé";
...
$GLOBALS['strZoneProbListChainLoop']	= "A zónalánc követése ismétlõdõ ciklust okozhat. A zónához történõ továbbítás leáll.";
...
$GLOBALS['strLinkedBannerHistory']		= "Kapcsolt reklám elõzményei";
...
$GLOBALS['strMatchingBanners']			= "{szám} egyezõ reklámok";
...
$GLOBALS['strConfirmResetStats']		= "Valóban törölni kívánja a létezõ teljes statisztikát?";
$GLOBALS['strGlobalHistory']			= "Globális elõzmények";
$GLOBALS['strDailyHistory']			= "Napi elõzmények";
$GLOBALS['strDailyStats'] 			= "Napi statisztika";
$GLOBALS['strWeeklyHistory']			= "Heti elõzmények";
$GLOBALS['strMonthlyHistory']			= "Havi elõzmények";
$GLOBALS['strCreditStats'] 			= "Követelési statisztika";
$GLOBALS['strDetailStats'] 			= "Részletes statisztika";
$GLOBALS['strTotalThisPeriod']			= "Idõszak összes";
$GLOBALS['strAverageThisPeriod']		= "Idõszak átlag";
...
$GLOBALS['strNoTargetStats']		= "Jelenleg nincs statisztika a célkijelölésrõl";


// Hosts
$GLOBALS['strHosts']				= "Állomások";
$GLOBALS['strTopHosts'] 			= "Népszerû kérõ állomások";
$GLOBALS['strTopCountries'] 		= "Népszerû kérõ országok";
$GLOBALS['strRecentHosts'] 			= "Legutóbbi kérõ állomások";
...
$GLOBALS['strAction']				= "Mûvelet";
$GLOBALS['strNoActionsLogged']			= "Nincs naplózott mûvelet";
...
$GLOBALS['strParameters']			= "Jellemzõk";
...
$GLOBALS['strLogErrorClients'] 			= "[phpAds] Hiba történt a hirdetõk adatbázisból történõ kiolvasásakor.";
$GLOBALS['strLogErrorBanners'] 			= "[phpAds] Hiba történt a reklámok adatbázisból történõ kiolvasásakor.";
$GLOBALS['strLogErrorViews'] 			= "[phpAds] Hiba történt a reklámletöltések adatbázisból történõ kiolvasásakor.";
$GLOBALS['strLogErrorClicks'] 			= "[phpAds] Hiba történt a kattintások adatbázisból történõ kiolvasásakor.";
$GLOBALS['strErrorViews'] 			= "Írja be a letöltések számát, vagy jelölje be a korlátlan jelölõnégyzetet !";
$GLOBALS['strErrorNegViews'] 			= "A negatív letöltések nem engedélyezettek";
$GLOBALS['strErrorClicks'] 			= "Írja be a kattintások számát, vagy jelölje be a korlátlan jelölõnégyzetet !";
...
$GLOBALS['strErrorUploadBasedir']		= "Nem lehet hozzáférni a feltöltött fájlhoz, valószínûleg a csökkentett mód, vagy az open_basedir korlátozások miatt";
$GLOBALS['strErrorUploadUnknown']		= "Nem lehet ismeretlen ok miatt hozzáférni a feltöltött fájlhoz. Ellenõrizze a PHP beállításokat";
$GLOBALS['strErrorStoreLocal']			= "Hiba történt a reklám helyi könyvtárba történõ mentésekor. Valószínûleg a rosszul megadott helyi mappa útvonala a magyarázata";
$GLOBALS['strErrorStoreFTP']			= "Hiba történt a reklám FTP-kiszolgálóra történõ feltöltésekor. Ez azért történhetett, mert a kiszolgáló nem elérhetõ, vagy hiba van az FTP-kiszolgáló beállításaiban";
$GLOBALS['strErrorDBPlain']				= "Hiba történt az adatbázishoz történõ hozzáféréskor";
...
$GLOBALS['strErrorDBCorrupt']			= "Valószínûleg sérült az adatbázis tábla, ezért javításra szorul. A sérült táblákkal kapcsolatban további részleteket olvashat az <i>Administrator guide</i> <i>Troubleshooting</i> fejezetében.";
$GLOBALS['strErrorDBContact']			= "Vegye fel a kapcsolatot a kiszolgáló adminisztrátorával, és értesítse õt a problémáról.";
$GLOBALS['strErrorDBSubmitBug']			= "Ha ez a probléma megismételhetõ, akkor lehet, hogy a ".$phpAds_productname." hibája okozta. Jelentse a következõ adatokat a ".$phpAds_productname." fejlesztõinek. Amennyire csak lehet, próbálja meg pontosan ismertetni azokat a mûveleteket, melyek ezt a hibát okozták.";
$GLOBALS['strMaintenanceNotActive']		= "Az utóbbi 24 órában nem történt meg a karbantartás parancsfájl futtatása. \\nA ".$phpAds_productname." megfelelõ mûködéséhez óránként futtatás szükséges. \\n\\nAz Administrator guide kézikönyvben részletes tájékoztatót olvashat \\na karbantartás parancsfájl beállításáról.";
...
$GLOBALS['strMailClientDeactivated'] 		= "A következõ reklámok törlésre kerültek, mert";
...
$GLOBALS['strNoViewLoggedInInterval']   	= "Egy reklámletöltés sem került naplózásra a jelentés idõtartama alatt";
$GLOBALS['strNoClickLoggedInInterval']  	= "Egy kattintás sem került naplózásra a jelentés idõtartama alatt";
