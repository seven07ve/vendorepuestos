...
if ($_pagi_actual != 1){
	...
	$_pagi_navegacion .= "<a href='".$_pagi_enlace."pg=".$_pagi_url."&categoria_buscar=".$categoria_buscar."&palabra=".$palabra."' class=\"pag\">&laquo; Anterior</a>&nbsp;";
}
...
for ($_pagi_i = 1; $_pagi_i<=$_pagi_totalPags; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
    if ($_pagi_i == $_pagi_actual) {
        ...
        $_pagi_navegacion .= "<span class=pag>$_pagi_i &nbsp;&nbsp;</span>";
    }else{
		//Si es cualquier otro. Se escibe el enlace a dicho número de página.
        $_pagi_navegacion .= "<a href='".$_pagi_enlace."pg=".$_pagi_i."&categoria_buscar=".$categoria_buscar."&palabra=".$palabra."' class=\"pag\">".$_pagi_i."</a>&nbsp;&nbsp;";
    }
}
...
if ($_pagi_actual < $_pagi_totalPags){
    ...
    $_pagi_url = $_pagi_actual + 1;//será el número de página al que enlazamos
    $_pagi_navegacion .= "<a href='".$_pagi_enlace."pg=".$_pagi_url."&categoria_buscar=".$categoria_buscar."&palabra=".$palabra."' class=\"pag\">Siguiente &raquo;</a>";
}
