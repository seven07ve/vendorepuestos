...
<body>
	<form name="form1" action="#" onSubmit="return check(this);">
		 <input name="rif" type="text" class="form" placeholder="J-xxxxxxxx-x" size="20" maxlength="12" autocomplete="off" onkeyup="comprobar(this.value)" /><span id="comprobar_mensaje"></span><br>		
