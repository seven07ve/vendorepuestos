...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <tr>
          <td height="30" colspan="5" class="titulo_ruta"><?=$nombretr?> > Mi Cuenta > Productos Finalizados</td>
  ...
  <tr>
    <td colspan="7" class="titulo_seccion"><span class="red"><?=$_pagi_totalReg;?></span> Art&iacute;culos Finalizados
<?php 
if (!empty($_POST['busqueda'])){
