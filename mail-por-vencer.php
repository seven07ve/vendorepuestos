...
?>
<body>
<div style="width:750px; font-family:\'Oswald\', sans-serif; background-color:#E4E4E3; padding:25px; color:#262626;"><img src="www.vendorepuestos.com.ve/imagenes/cabecera-peq.jpg" width="750" height="112" alt=""/>
...
<table width="100%" border="0" align="right" cellpadding="3" cellspacing="0" style="font-size:12px;">
  <tr height="25" style="background: url(http://vendorepuestos.com.ve/imagenes/bg_botonera.jpg);" class="menu">
    ...
    <td width="110">VENCE</td>
      ...
      <div style="width:98%; height:110px; font-size:12px; border-radius: 10px; border: 1px solid #D3D3D3; margin:0 0 5px 0; padding:8px;">
        <div style="width:320px; float:left;">
          <a href="http://vendorepuestos.com.ve/articulo/<?php echo limpiar_cadena($vpt["titulo"])?>/<?php echo $vpt["id"]?>">
          	<img src="http://vendorepuestos.com.ve/<?php echo $carpeta_productos?>/<?php echo $vpt["foto1"]?>" width="125" height="88" hspace="5" vspace="5" border="0" align="left" />
          </a>
          <span style="color: #69A02A;">
          	<a href="http://vendorepuestos.com.ve/articulo/<?php echo limpiar_cadena($vpt["titulo"])?>/<?php echo $vpt["id"]?>" style="color: #69A02A;"><?php echo $vpt["titulo"]?></a>
          	</span><br />
          <?php echo $vpt["subtitulo"]?>
	  </div>
        <div class="red" style="width:120px; float:left;"><?php echo $vpt["precio"]?></div>
        <div class="gris" style="width:120px; float:left;"><?php echo $vpt["visitas"]?></div>
        <div class="gris" style="width:120px; float:left;"><?php echo numero_articulo($vpt["id"]);?></div>
        <div class="gris" style="width:120px; float:left;"><?php echo $vpt["vence"]?><br /> 
            <?php echo cual_estado($vpt["id_estado"])?></div>
      </div>
</div>
</div>
</body>
