...
//-->
    ...
    <div style="width:685px; height:120px; border-radius: 10px;border: 1px solid #D3D3D3; margin:0 0 5px 0; padding:8px; clear:both;">
	  <div style="width:480px; float:left; margin:0 5px 0 0">
			...
			<?php if($b["usuario_tienda"]=="2"){?>visite <?php echo cual_usuario_resultado($b["id_usuario_tienda"],2)?><br /><a href="/<?php echo limpiar_cadena(cual_usuario($b["id_usuario_tienda"],2))?>/<?php echo $b["id_usuario_tienda"]?>/0/0/1"><img src="/imagenes/icon_tr.jpg" width="33" height="25" border="0" /></a><?php }?><br />
            </div>
