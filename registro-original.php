...
//		$params = "?email=$email&tienda=$id&monto=$monto_paquete";
		...
		3. Espera la activación de acuerdo a los Términos y Condiciones.<br>
		4. Completar los requisitos y enviarlos al correo administración@vendorepuestos.com.ve<br>
		•	Copia de Registro de Comercio. (Títulos I, Títulos II y Títulos III)<br>
		•	Copia de RIF. <br>
		•	Copia de servicio público con domicilio Fiscal o un equivalente.<br>
		•	Copia de Tarjeta de Crédito<br><br>
