...
//		$params = "?email=$email&tienda=$id&monto=$monto_paquete";
		...
		$message= '<div style="width:750px; background-color:#2B2B29; padding:50px;" align="center"><span style="font-family:\'Oswald\', sans-serif; font-size:28px; color:#E1ED1B; font-weight:bold;">vendorepuestos.com.ve</span>
<div style="width:700px; font-family:\'Oswald\', sans-serif; font-size:20px; color:#FFF; border:1px dashed #666; padding:30px;">
<br /><span style="color:#FFFFFF; font-weight:bold;">
Hay un nuevo registro en TIENDAREPUESTOS.<br><br>
		<b>Datos de la publicación</b> 
...
<div style="width:700px; font-family:\'Oswald\', sans-serif; font-size:20px; color:#FFF; border:1px dashed #666; padding:30px;">
<br /><span style="color:#FFFFFF; font-weight:bold;">
Gracias <b>'.$nombre_oficial.'</b> por confiar en <br><span style="color:#69A02A;">vendorepuestos.com.ve</span><br><br> 
		...
		4. Comple	tar los requisitos y enviarlos al correo <span style="color:#69A02A;">administración@vendorepuestos.com.ve</span><br><br>
		...
		<span style="color:#E1ED1B;"><b>Información Bancaria</b></span><br>
		...
		<span style="color:#E1ED1B;">Gracias por usar vendorepuestos.com.ve.</span>
</span></div></div>';
...
<tr>
  ...
  <td colspan="2" class="campo">
	...
	<label for="file-input">
		<img src="../imagenes/camera.png"/> <span class="blue">Recomendado 210x60</span>
	</label>
...
<tr>
  ...
  <td colspan="2" class="campo">
	...
	<label for="file-input4">
		...
		<input id="file-input4" name="file4" type="file" class="form"/>
	</div>
  </td>
</tr>
<tr>
  ...
  <td colspan="2" class="campo">
  <input name="razon_social" type="text" class="form" size="50" onkeyup="comprobarrazon(this.value)" /><span id="comprobar_mensaje"></span>
  *</td>
</tr>
<tr>
  ...
  <td colspan="2" class="campo">
  <input name="nombre_oficial" type="text" class="form" size="50" maxlength="35" />
  *</td>
</tr>
<tr>
  <td class="desc">Documento de Identidad/RIF:</td>
  <td colspan="2" class="campo">
  <input name="rif" type="text" class="form" value="J-" size="20" maxlength="12" /> 
...
<tr>
  ...
  <td width="373" class="campo">
	<input type="color" id="colorpicker" name="color_titulo" >
  </td>
...
<tr>
  ...
  <td class="campo">
	<input type="color" id="colorpicker" name="color_fondo" >
  </td>
  </tr>
<tr>
  <td class="desc">Color Fondo Contenido:</td>
  <td class="campo">
	<input type="color" id="colorpicker" name="color_contenido" >
  </td>
  </tr>
<tr>
...
<?php if($paso==2) : ?>
    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <span class="titulo_seccion" style="font-size:22px;">Su informaci&oacute;n se ha registrado Satisfactoriamente.</span><br />
    <img src="/imagenes/CHECK.png" alt="" /><br />
        <span class="titulo_seccion" style="font-size:22px;"></span><br /><br />
