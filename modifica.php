...
if(isset($_POST["paso"])==2)
{
	...
	//EMAIL AL CLIENTE
	$to = $_POST["email"];
	$subject = "Información de Modificación Artículo ha sido recibida";
	
	//EMAIL VR
	$to2 = "administracion@vendorepuestos.com.ve";
	$subject2 = "Información de Modificación Artículo";
	
	$headers = "From: administracion@vendorepuestos.com.ve\r\n";
	$headers .= "MIME-Version: 1.0\n" . "Content-Type: multipart/mixed;\n" . " boundary=\"{$mime_boundary}\"";
	
	$message.= "Hemos recibido la siguiente información para Modificar el artículo";
	...
	$VR_msj= $message."La información ha reeditar  es la siguiente:<br><br>";
	
	$cliente_msj= $message."En caso de que usted no haya enviado esta información, contáctenos a la brevedad.<br><br>La información ha reeditar  es la siguiente:<br>";
	...
	//cliente
	$cliente_msj.=$message."Si hubo alguna modificación del precio a un rango mas alto, proceda a realizar el pago diferencial y acuda al Centro de Pagos para reportar el depósito. Para mas información consulte la sección Tarifas.<br><br>
Para información adicional contacte nuestra sección de Preguntas Frecuentes.<br><br>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" align="center"><span class="titulo_seccion">Su información se ha registrado Satisfactoriamente.</span><br /><br />
      <span class="titulo_seccion">Para proceder a la publicación, Realiza el pago correspondiente. Información enviada a su correo electrónico.</span><br /><br /><span class="red">Deseo pagar por mi publicación<br />Monto Bs.
<?=$monto_paquete?></span>
</td>
  </tr>
  <tr>
