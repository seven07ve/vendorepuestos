      ...
      <div style="clear:both;">
          <table width="960" border="0" cellspacing="0" cellpadding="0">
        	<tr>
			  ...
			  <? if($detail["usuario_tienda"]=="2"){?><a href="/tr/<?=limpiar_cadena($nombretr)?>/<?=$detail["id_usuario_tienda"]?>/0/0/1"><img src="/imagenes/icon_tr_grande.jpg" width="66" height="50" border="0" /></a><br />visite <?=$nombretr?>
			  <? }
        	...
        	<tr>
        	  <td colspan="2">
              <div style="width:460px; height:80px; border-radius: 10px;border: 1px solid #D3D3D3; margin:0 0 5px 5px; padding:8px; float:left;"><span class="titulo_seccion">Pagos</span> <div id="linea_division"></div>
              <?
              ...
              <div style="width:470px; height:80px; border-radius: 10px;border: 1px solid #D3D3D3; margin:0 0 5px 10px; padding:8px; float:left;"><span class="titulo_seccion">Envios</span> <div id="linea_division"></div>
              <? 
