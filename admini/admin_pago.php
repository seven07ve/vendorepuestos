...
if($_POST['guardar']){
	$nombre = $_POST["nombre"];
	$insert = mysql_query("INSERT INTO medio_pago (nombre) VALUES ('$nombre')");
	header('location:admin_pago.php');
}
	
if($_POST['editar']){
	$id = $_POST["id"];
	$nombre = $_POST["nombre"];
	$update = mysql_query("UPDATE medio_pago SET nombre='$nombre' WHERE id=$id");
	header('location:admin_pago.php');
	}
	
if($_GET['o']=='eliminar'){
	$id = $_GET["id"];
	$delete = mysql_query("DELETE FROM medio_pago WHERE id=$id");
}
?>
...
<script type="text/javascript">
	function eliminar(_id){
		if(confirm('Esta seguro que desea eliminar este Medio de Pago?')){
			window.location.href='admin_pago.php?o=eliminar&id=' + _id;		
		}
	}
</script>
</head>
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
          <tr>
            <td><a href="admin_pago_agregar.php"><img src="imagenes/agregar_big.png" width="100" height="50" border="0" /></a></td>
          </tr>
        </table>
...
<tr>
<td class="tabla_titulo" nowrap="nowrap"> Medio de Pago</td>
</tr>
<tr>
<td>
<?php 
$_pagi_sql = "SELECT * FROM medio_pago ORDER BY id";
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  ...
  <?php while($resul = mysql_fetch_array($_pagi_result)){?>
   <tr>
    ...
    <td nowrap="nowrap"><a href="admin_pago_editar.php?id=<?=$resul["id"]?>"><img src="imagenes/editar.png" width="20" height="20" border="0" /></a></td>
