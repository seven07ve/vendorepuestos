...
$id = $_GET['id'];	
$sql = "SELECT * FROM medio_envio WHERE id=$id";
$res = mysql_query($sql);
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
          <tr>
            <td><a href="admin_envio.php"><img src="imagenes/cancelar_big.png" width="100" height="50" border="0" /></a></td>
            <td>&nbsp;&nbsp;</td>
		...
		<form action="admin_envio.php" method="post" name="form1" onsubmit="return validar(this);">
