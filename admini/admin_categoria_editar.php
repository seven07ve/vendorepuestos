    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
          <tr>
            <td><a href="admin_categoria.php"><img src="imagenes/cancelar_big.png" width="100" height="50" border="0" /></a></td>
            <td>&nbsp;&nbsp;</td>
		...
		<form action="admin_categoria.php" method="post" name="form1" onsubmit="return validar(this);">
...
<tr>
<td class="desc">Presentacion:</td>
<td class="campo"><input name="presentacion" type="radio" value="1" <? if($resul["presentacion"]==1){?>checked="checked"<? }?> />
  Nivel 2
    <input type="radio" name="presentacion" value="2" <? if($resul["presentacion"]==2){?>checked="checked"<? }?>/>
    Logos</td>
</tr>
<tr>
