...
{
	new Ajax.Request("admin_productos_agregar.php?buscar=1&edo="+edo+"&ciu="+ciu,{
	method: 'get',
	onSuccess: function(transport) {
...
<tr>
<td colspan="2" class="tabla_titulo">Agregar Productos</td>
</tr>
<tr>
  <td class="desc">T&iacute;tulo:</td>
  <td class="campo"><input name="titulo" type="text" class="form" size="50" maxlength="75" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td class="campo"><input name="precio" type="text" class="form" size="10"/> (ej. 00.00)</td>
</tr>
<!--<tr>
  <td height="41" class="desc">Vence:</td>
  <td class="campo"><input id="fecha" name="fecha" class="form" size="40"/>
  ...
  <script type="text/javascript">//<![CDATA[
	...
	cal.manageFields("f_btn1", "fecha", "%Y-%m-%d");
	//]]></script>    </td>
</tr>-->
<tr>
