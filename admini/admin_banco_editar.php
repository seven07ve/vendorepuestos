...
<table width="100%" height="" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" bgcolor="#333333" class="encuentra_en">UD. Se encuentra en: <strong>Banco</strong></td>
  </tr>
  <tr>
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
          <tr>
            <td><a href="admin_banco.php"><img src="imagenes/cancelar_big.png" width="100" height="50" border="0" /></a></td>
            <td>&nbsp;&nbsp;</td>
		...
		<form action="admin_banco.php" method="post" name="form1" enctype="multipart/form-data" onsubmit="return validar(this);">
...
<tr class="tabla">
  ...
  <td class="campo"><? if($resul["logo"]!=""){  ?><img src="../logos_bancos/<?=$resul["logo"]?>" height="50" /><? }?></td>
</tr>
<tr class="tabla">
