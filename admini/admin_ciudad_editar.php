    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
          <tr>
            <td><a href="admin_subcategoria.php"><img src="imagenes/cancelar_big.png" width="100" height="50" border="0" /></a></td>
            <td>&nbsp;&nbsp;</td>
            <td><a href="admin_subcategoria_agregar.php"><img src="imagenes/agregar_big.png" width="100" height="50" border="0" /></a></td>
          </tr>
        </table>

        <!-- FINAL SUBsubcategoria -->
        
		<form action="admin_ciudad.php" method="post" name="form1" onsubmit="return validar(this);">
            <table border="0" cellspacing="0" cellpadding="0" class="tabla_resultados">
<tr>
<td colspan="2" class="tabla_titulo">Editar Categoría</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="campo"><select name="id_estado" class="form">
    <option value="0">Seleccionar</option>
    <?php 
$sql_categoria=mysql_query("SELECT * FROM estado ORDER BY id");
while($categoria=mysql_fetch_array($sql_categoria)){
?>
    <option value="<?=$categoria["id"]?>" <?php if($resul["id_estado"]==$categoria["id"]) echo "selected";?>><?=$categoria["nombre"]?></option>
    <?php }?>
  </select></td>
</tr>
