...
$id = $_GET['id'];	
$sql = "SELECT * FROM contenidos_usuarios WHERE id=$id";
$res = mysql_query($sql);
...
<tr>
<td colspan="2" class="tabla_titulo">Editar Contenido</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="campo"><select class="form" name="id_tipo_usuario">
	...
	{
	?>
    <option value="<?=$tipo_usuario["id"]?>" <?php if($resul["id_tipo_usuario"]==$tipo_usuario["id"]) echo "selected";?>><?=$tipo_usuario["descripcion"]?></option>
    <?php 
	}
	?>
  </select>  </td>
