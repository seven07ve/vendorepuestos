...
{
	new Ajax.Request("admin_tiendas_agregar.php?buscar=1&menu="+menu+"&submenu="+submenu,{
	method: 'get',
...
<tr>
<td colspan="2" class="tabla_titulo">Agregar Tienda Virtual</td>
</tr>
<tr>
  <td class="desc">Paquete:</td>
  <td class="campo"><select name="id_paquete" class="form">
...
<tr>
  ...
  <td class="campo"><input name="razon_social" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td class="desc">Nombre Oficial:</td>
  <td class="campo"><input name="nombre_oficial" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td class="desc">RIF: </td>
  <td class="campo"><input name="rif" type="text" class="form" value="J-" size="20" maxlength="15" /> 
    (ej. J-00000)</td>
</tr>
<tr>
  <td class="desc">Telefono1:</td>
  <td class="campo"><input name="telefono1" type="text" class="form" size="50" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td class="campo"><input name="direccion" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td class="desc">Google Maps:</td>
  <td class="campo">Latitud: 
     <input name="latitud" type="text" class="form" size="10" />
    Longitud:
...
<tr>
  ...
  <td class="campo"><input name="pagina_web" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td class="desc">Descripcion:</td>
  <td class="campo"><textarea name="descripcion" cols="45" rows="5" class="form"></textarea></td>
</tr>
<tr>
  <td class="desc">Horario de Atenci&oacute;n:</td>
  <td valign="top" class="campo"><textarea name="horario" cols="45" rows="5" class="form"></textarea>
    *</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="campo"><input name="email" type="text" class="form" size="50" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td bgcolor="#e1e1e1" class="campo"><input name="persona_mantenimiento" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td bgcolor="#e1e1e1" class="desc">Telf. Persona Mantenimiento:</td>
  <td bgcolor="#e1e1e1" class="campo"><input name="telefono_mantenimiento" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td bgcolor="#e1e1e1" class="desc">Email Persona Mantenimiento:</td>
  <td bgcolor="#e1e1e1" class="campo"><input name="email_mantenimiento" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td bgcolor="#cccccc" class="desc">Usuario:</td>
  <td bgcolor="#cccccc" class="campo"><input name="usuario" type="text" class="form" size="50" /></td>
</tr>
<tr>
  <td bgcolor="#cccccc" class="desc">Contrase&ntilde;a:</td>
  <td bgcolor="#cccccc" class="campo"><input name="contrasena" type="password" class="form" size="50" maxlength="8" /></td>
</tr>
<tr>
  <td bgcolor="#cccccc" class="desc">Confirmar Contrase&ntilde;a:</td>
  <td bgcolor="#cccccc" class="campo"><input name="confirmacion" type="password" class="form" size="50" maxlength="8" /></td>
</tr>
