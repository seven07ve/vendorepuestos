...
<tr>
<td colspan="2" class="tabla_titulo">Agregar Publicaci&oacute;n</td>
</tr>
<tr>
...
<tr class="tabla">
  ...
  <td class="campo"><input id="imagen" name="imagen" type="text" size="33" class="form"/>
...
<tr class="tabla" id="_archivo" style="display:none;">
  ...
  <td class="campo"><input id="archivo" name="archivo" type="text" size="33" class="form"/>
