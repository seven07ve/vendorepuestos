...
//        $cryptpass = md5( $salt . $password);
	...
	$precio = $_POST["precio"];
	$vence = "DATE_ADD(NOW(), INTERVAL 30 DAY)";
...
/*	if($_POST["desea_cliente_premium"]=="si")//email al cliente
	...
	$message = '<div style="width:750px; font-family:\'Oswald\', sans-serif; background-color:#E4E4E3; padding:50px; color:#262626;"><img src="www.vendorepuestos.com.ve/imagenes/cabecera-peq.jpg" width="750" height="112" alt=""/>
  <div style="width:700px; font-size:20px; padding:30px;">
<div style="text-align:center;  font-weight:bold;">Se ha registrado un artículo CP por parte de: <b>'.$nombre.'</b><br><span style="color:#69A02A;">vendorepuestos.com.ve</span></div>
<p><strong>Datos de la publicación</strong><br>
  El usuario: '.$nombre.'<br> 
  Documento de Identidad: '.$cedula.'<br>
  El número de su artículo es: '.$numero_articulo.'<br>
  Título: '.$titulo.'<br><br>
  Fecha de Registro: '.date("d-m-Y").'</p>
<p><span style="color:#69A02A;"> vendorepuestos.com.ve.</span></p>
  </div></div>';
...
@font-face {
font-family: "sofia";
src: url("https://www.vendorepuestos.com.ve/sofia.ttf");
}
.image-upload > input{
    display: none;
}
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" align="center"><span class="titulo_seccion" style="font-size:22px;">Su informaci&oacute;n se ha registrado Satisfactoriamente.</span><br />
    <img src="/imagenes/CHECK.png" alt="" /><br />
        <span class="titulo_seccion" style="font-size:22px;">En minutos su anuncio ser&aacute; publicado.</span><br /><br /><span class="red">
...
<tr class="tabla">
  ...
  <div class="image-upload">
    <label for="file-input">
        <img id="subir1" src="../imagenes/camera.png"  />
    </label>
...
<!--   <input name="file" type="file" class="form" /></td> -->
</tr>
<!--<tr>
  <td height="41" class="desc">Imagen 2:</td>
  <td colspan="3" class="campo">
   <input name="file2" type="file" class="form" /></td>
</tr> -->
<!-- <tr>
