...
$_pagi_sql = "SELECT * FROM productos WHERE vence>= NOW() && usuario_tienda='2' && id_usuario_tienda='$id' && id_estado='$ide'";
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
  	...
  	<td width="110"><form action="/tr_ubicacion/<?=$carpeta?>/<?=$id?>/<?=$ide?>/1/0/1/" method="post">PRECIO <input type="image" name="imageField" id="imageField" src="/imagenes/icon_arrow_sist_ne.jpg" /></form></td>
    <td width="110"><form action="/tr_ubicacion/<?=$carpeta?>/<?=$id?>/<?=$ide?>/0/1/1/" method="post">VENCE 
